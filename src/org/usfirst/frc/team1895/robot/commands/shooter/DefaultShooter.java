...
public class DefaultShooter extends Command {
	...
	/**
	 * Set the shooter and regulator to the desired speed from the second driver's
	 * controller.
	 */
	@Override
	protected void execute() {
		shooter.setRegulator(driverTwo.getAxis(F310.LY));
		shooter.setShooterSpeed(driverTwo.getAxis(F310.RY));
//		System.out.println("setting reg " + driverTwo.getAxis(F310.LY) + " shooter " + driverTwo.getAxis(F310.RY));
	}

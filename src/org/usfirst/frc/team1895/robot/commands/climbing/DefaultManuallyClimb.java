...
/**
 * 2/15/2017 (Maddy Seputro) Description: Allows user to manually control the
 * winch motor and climbing of the robot. To do still: - Test Added: requires
 * statement, execute
 */
public class DefaultManuallyClimb extends Command {
	...
	protected void execute() {
		// drives up
		if (Robot.oi.gamepad2.getAxis(F310.LT) > Robot.oi.gamepad2.getAxis(F310.RT)
				&& Robot.oi.gamepad2.getAxis(F310.LT) > 0.2) {
			...
			System.out.println("Climbing down vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv");
		} else {
